...
class PublicTestAudioLibraryViews(TestCase):
    ...
    def test_update_license_unauthorized(self):
        ...
        res = self.client.put(
            reverse("audio:license_detail", [self.license.id]), payload
        )
    ...
    def test_create_album_unauthorized(self):
        ...
        res = self.client.post(reverse("audio:album"), payload)
    ...
    def test_update_album_unauthorized(self):
        ...
        res = self.client.put(reverse("audio:album_detail", [self.album.id]), payload)
    ...
    def test_update_track_unauthorized(self):
        ...
        res = self.client.put(reverse("audio:track_detail", [self.track.id]), payload)
    ...
    def test_delete_comments_unauthorized(self):
        res = self.client.delete(reverse("audio:comments_detail", [self.comment.id]))
    ...
    def test_delete_playlist_unauthorized(self):
        res = self.client.delete(reverse("audio:playlist_detail", [self.playlist.id]))
...
class PrivateTestAudioLibraryViews(TestCase):
    ...
    def test_delete_license_user_author(self):
        ...
        res = self.client.delete(reverse("audio:license_detail", [license2.id]))
